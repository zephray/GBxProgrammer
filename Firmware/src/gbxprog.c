...
static void cdcacm_set_config(usbd_device *usbd_dev, uint16_t wValue)
{
	...
	usbd_ep_setup(usbd_dev, 0x04, USB_ENDPOINT_ATTR_BULK, 64, cdcacm_data_rx_cb);
...
int main(void)
{
	...
	usbd_dev = usbd_init(&st_usbfs_v1_usb_driver, &dev_descr, &config_descr,
			    usb_strings, 3,
			    usbd_control_buffer, sizeof(usbd_control_buffer));

	ramdisk_init();
	usb_msc_init(usbd_dev, 0x82, 64, 0x01, 64, "cnVtg", "GBxP",
